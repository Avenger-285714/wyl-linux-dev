 ...
 */
		switch (chunk_index) {
		case 0:
			enc_key_src_ptr = &aentry->ht_key.enc_key[chunk_key_offsets[2]];
			break;
		case 1:
			enc_key_src_ptr = &aentry->ht_key.enc_key[chunk_key_offsets[20]];
			break;
		case 2:
			enc_key_src_ptr = &aentry->ht_key.enc_key[chunk_key_offsets[38]];
			break;
		}
