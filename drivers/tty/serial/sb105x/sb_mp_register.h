...
#define SB105X_ISR_RCSI \
	0x20 /* RTS#, CTS# status interrupt during Auto RTS/CTS flow control */
...
#define SB105X_LCR_STOP \
	0x04 /* Stop bits: 0->1 bit, 1->2 bits, 1 and SB105X_LCR_WLEN5 -> 1.5 bit */
...
/* Xoff Re-transmit Count Register */
#define SB105X_XRCR 2
/* Transmits Xoff Character whenever the number of received data is 1 during XOFF status */
#define SB105X_XRCR_NRC1	0x00
/* Transmits Xoff Character whenever the number of received data is 4 during XOFF status */
#define SB105X_XRCR_NRC4	0x01
/* Transmits Xoff Character whenever the number of received data is 8 during XOFF status */
